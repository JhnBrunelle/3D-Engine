...
public:
	...
	*   Coord3 (in) - secondary vector to dot with
	*   returns this (dot) Coord3 operand
	*/
	double dotProduct(Coord3);

	/**
	* Calculate the magnitude of the coord
	* returns a double of the magnitude
	*/
	double mag();
